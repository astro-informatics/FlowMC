...
def dual_moon_pe(x):
    """
    Term 2 and 3 separate the distribution and smear it along the first and 
    second dimension
    """
...
print(
    'chains shape: ', chains.shape, 
    'local_accs shape: ', local_accs.shape, 
    'global_accs shape: ', global_accs.shape
    )
